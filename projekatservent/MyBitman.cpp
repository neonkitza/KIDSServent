...
public:
	...
	void saveBitmap(std::string path) {
		...
		HANDLE file = CreateFile((LPCWSTR)path.c_str(), GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
...
private:
	...
	{
		// --- edit this path --- //
		bmp.saveBitmap("D:/st.bmp");
	}
	void setPoint(POINT &o, POINT v, int i) {
		POINT z;
		o.x = (o.x + v.x) * distanceP; o.y = (o.y + v.y) * distanceP;
		SetPixel(bmp.getDC(), o.x, o.y, colors[rand()%2]);
	}
	void fillPts() {
		int a = BMP_SIZE - 1;
